$(function () {
    ...
    // Handler for Add Employee button (directly add editable row)
    ...
    refreshAllSkills();
    // Modal submit handles add/edit via AJAX
    ...
    // Main form handles bulk save only
    $('#mainEmployeeForm').on('submit', function (e) {
        var $form = $(this);
        e.preventDefault();
